    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin">UANGKAS</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    @if(!Auth::user()->foto)
                    <img src="{{ asset('img/user/default.png') }}" width="48" height="48" alt="image" />
                    @else
                    <img src="{{ asset('img/user/'.Auth::user()->foto) }}" width="48" height="48" alt="image" />
                    @endif
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="@yield('pengguna')">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">people_alt</i>
                            <span>Pengguna</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="@yield('bendahara')">
                    ...
                    <li class="@yield('pembayaran')">
                        ...
                        <ul class="ml-menu">
                            <li class="@yield('kas-masuk')">
                                <a href="/admin/pembayaran/masuk">Kas Masuk</a>
                            </li>
                            <li class="@yield('kas-keluar')">
